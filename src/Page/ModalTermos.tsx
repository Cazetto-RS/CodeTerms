...
import styles from "../Styles/StyleModalTermos";
    ...
    <Modal visible={visivel} animationType="slide" transparent={false}>
      <ScrollView style={styles.container} contentContainerStyle={{ alignItems: "flex-start" }}>
        <View style={{ padding: 30, width: "100%" }}>
          ...
          <Text style={styles.subtitle}>Sí-la-ba</Text>
        </View>
        <View style={{ paddingHorizontal: 30, width: "100%" }}>
          <View style={{ marginBottom: 30 }}>
            <Text style={styles.title2}>Tradução</Text>
            <Text style={styles.subtitle}>Palavra</Text>
          </View>
          ...
          {/* <View style={{ marginBottom: 20 }}>
          <Text style={styles.title2}>Imagem</Text>
          <View style={[styles.DivImage, styles.border]}>
            <Image
              source={require("../../foto.png")}
              style={{
                width: "100%",
                aspectRatio: 16 / 9, // Mantém a proporção de 1920x1080
                borderRadius: 10,
              }}
              resizeMode="contain" // Garante que a imagem inteira apareça sem cortes
            />
          </View>
        </View> */}
        </View>
